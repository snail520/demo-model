...
public abstract class ReflectionUtils {
	...
	private static Object handleValueType(Object obj, String propertyName,
		...
		if (returnType == Boolean.class) {
			...
			try {
				value = new SimpleDateFormat(DateUtil.FULL_TIME_FORMAT).parse(value.toString());
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(new SimpleDateFormat(DateUtil.FULL_TIME_FORMAT).parse(ts.toString()));
	}
